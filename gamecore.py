...
print ("If the letter is in the word, All matching positions are revealed, else one attempt is lost.")
print ("The player wins by guessing all letters in the word before attempts run out.")
print ("The player loses if all allowed wrong guesses are used before the word is complete.")
print ("All words are 6 letter and you will get only 3 hints")
print input()
